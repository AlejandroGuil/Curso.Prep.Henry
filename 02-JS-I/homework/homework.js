...
function esPositivo(numero) {
  ...
  if (numero>0){var str = "Es positivo"; return(str) }
  if (numero<0){var str = "Es negativo"; return(str)}
  return(false)
}
...
function esVocal(letra){
  ...
  //Escribe tu código aquí
  if(letra.length===1){
    if(letra==="a"){var str = "Es vocal"; return(str)}
    if(letra==="A"){var str = "Es vocal"; return(str)}
    if(letra==="e"){var str = "Es vocal"; return(str)}
    if(letra==="E"){var str = "Es vocal"; return(str)}
    if(letra==="i"){var str = "Es vocal"; return(str)}
    if(letra==="I"){var str = "Es vocal"; return(str)}
    if(letra==="o"){var str = "Es vocal"; return(str)}
    if(letra==="O"){var str = "Es vocal"; return(str)}
    if(letra==="u"){var str = "Es vocal"; return(str)}
    if(letra==="U"){var str = "Es vocal"; return(str)}
